        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Patricia-Apaza/Prueba-Test-B.git'
                }
            }
        }
        stage('Build') {
